...
Defined in: [packages/db/src/query/expression-helpers.ts:39](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/query/expression-helpers.ts#L39)
