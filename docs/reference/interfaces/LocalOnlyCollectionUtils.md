...
Defined in: [packages/db/src/local-only.ts:40](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/local-only.ts#L40)
...
Defined in: [packages/db/src/local-only.ts:58](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/local-only.ts#L58)
