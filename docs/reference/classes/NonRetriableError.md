...
Defined in: [packages/db/src/errors.ts:10](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L10)
...
Defined in: [packages/db/src/errors.ts:11](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L11)
