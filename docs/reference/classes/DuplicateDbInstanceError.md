...
Defined in: [packages/db/src/errors.ts:45](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L45)
...
Defined in: [packages/db/src/errors.ts:46](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L46)
