...
Defined in: [packages/db/src/errors.ts:71](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L71)
...
Defined in: [packages/db/src/errors.ts:72](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L72)
