...
Defined in: [packages/db/src/errors.ts:78](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L78)
...
Defined in: [packages/db/src/errors.ts:79](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L79)
