...
Defined in: [packages/db/src/errors.ts:84](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L84)
...
Defined in: [packages/db/src/errors.ts:85](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L85)
