...
Defined in: [packages/db/src/errors.ts:2](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L2)
...
Defined in: [packages/db/src/errors.ts:3](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L3)
