...
Defined in: [packages/db/src/errors.ts:90](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L90)
...
Defined in: [packages/db/src/errors.ts:91](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/errors.ts#L91)
