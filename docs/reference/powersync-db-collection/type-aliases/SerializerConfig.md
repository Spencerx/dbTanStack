...
Defined in: [definitions.ts:61](https://github.com/Spencerx/dbTanStack/blob/main/packages/powersync-db-collection/src/definitions.ts#L61)
...
Defined in: [definitions.ts:94](https://github.com/Spencerx/dbTanStack/blob/main/packages/powersync-db-collection/src/definitions.ts#L94)
...
Defined in: [definitions.ts:87](https://github.com/Spencerx/dbTanStack/blob/main/packages/powersync-db-collection/src/definitions.ts#L87)
