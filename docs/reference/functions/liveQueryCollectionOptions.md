...
Defined in: [packages/db/src/query/live-query-collection.ts:62](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/query/live-query-collection.ts#L62)
