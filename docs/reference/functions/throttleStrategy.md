...
Defined in: [packages/db/src/strategies/throttleStrategy.ts:48](https://github.com/Spencerx/dbTanStack/blob/main/packages/db/src/strategies/throttleStrategy.ts#L48)
